...
--
-- Host: localhost    Database: empresaFIltro
-- ------------------------------------------------------
...
CREATE TABLE `contratacion` (
  ...
  `fecha_aplication` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `estado` varchar(255) NOT NULL,
  `salario` decimal(10,2) NOT NULL,
  `id_vacante` int NOT NULL,
  `id_coder` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_idvacante` (`id_vacante`),
  KEY `FK_idcoder` (`id_coder`),
...
-- Dump completed on 2024-04-09 12:54:54
